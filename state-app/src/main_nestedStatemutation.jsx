    ...
    onUpdate = () => {
        this.setState((prevState) => {
            return {
                ...
                customer: {
                    ...prevState.customer, //copy all customer outer properties
                    contact: {
                        ...prevState.customer.contact, //copy all contact properties
                        communcation: {
                            ...prevState.customer.contact.communcation, //copy all communcation properties
                            mobileNo: '9003706368'
                        }
                    }
                }
